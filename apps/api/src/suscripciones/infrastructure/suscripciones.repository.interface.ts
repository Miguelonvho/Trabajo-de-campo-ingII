...
export abstract class ISuscripcionesRepository {
   ...
   */
  public abstract crearSuscripcion(suscripcion: Suscripcion): Promise<Suscripcion>;

  /**
   * Actualiza los datos de una suscripción existente.
   */
  public abstract actualizarSuscripcion(suscripcion: Suscripcion): Promise<Suscripcion>;

  /**
   * Busca una suscripción por su ID de dominio.
   */
  public abstract buscarSuscripcionPorId(id: string): Promise<Suscripcion | null>;

  /**
   * Busca una suscripción por su ID correspondiente de Mercado Pago (preapproval_id / mp_subscription_id).
   */
  public abstract buscarSuscripcionPorMpId(mpSubscriptionId: string): Promise<Suscripcion | null>;
